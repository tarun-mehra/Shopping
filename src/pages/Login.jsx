...
export default function Login() {
    return (
        <div class="flex items-center min-h-screen p-4 bg-gray-100 lg:justify-center">
            ...
            >
                <div
                    class="p-4 py-6 text-white bg-gray-600 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly"
                >
                    ...
                    <form action="#" class="flex flex-col space-y-5">
                        ...
                        <div class="flex flex-col space-y-1">
                            <div class="flex items-center justify-between">
                                ...
                                <a href="#" class="text-sm text-gray-800 hover:underline focus:text-blue-800">Forgot Password?</a>
                            </div>
                            <input
                                type="password"
                                id="password"
                        ...
                        <div>
                            <button
                                type="submit"
                                class="w-full px-4 py-2 text-lg font-semibold text-white transition-colors duration-300 bg-gray-500 cursor-pointer rounded-md shadow hover:bg-gray-800 focus:outline-none focus:ring-blue-200 focus:ring-4">
                                Log in
                            </button>
                        </div>
